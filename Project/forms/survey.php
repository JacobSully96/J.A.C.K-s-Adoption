...
<br>
    ...
    <div class="d-flex flex-column justify-content-center align-items-center">
        <form method="POST" class="form-horizontal">
            ...
            <input type="radio" id="hometype" name="hometype" value="Apt/Condo">
            <label for="hometype">Apartment/Condo</label>
            <br>
            <input type="radio" id="hometype" name="hometype" value="House">
            ...
            <input type="number" id="annualCost" name="annualCost" value="annualCost">

            <p>4. Would you like a pet that is good with older children (over 8)?
            </p>

            <input type="radio" id="olderChildFriendly" name="olderChildFriendly" value="Yes">
            <label for="olderChildFriendly">Yes</label>
            <br>
            <input type="radio" id="olderChildFriendly" name="olderChildFriendly" value="No">
            <label for="olderChildFriendly">No</label>

            <p>5. Would you like a pet that is good with younger children (younger than 8)?
            </p>

            <input type="radio" id="youngerChildFriendly" name="youngerChildFriendly" value="Yes">
            <label for="youngerChildFriendly">Yes</label>
            <br>
            <input type="radio" id="youngerChildFriendly" name="youngerChildFriendly" value="No">
            <label for="youngerChildFriendly">No</label>

            <p>6. How much time can you dedicate to helping your pet exercise?
            </p>

            <input type="radio" id="petExercise" name="petExercise" value="Low">
            <label for="petExercise">Low - 20 to 30 minutes a day</label>
            <br>
            <input type="radio" id="petExercise" name="petExercise" value="Medium">
            <label for="petExercise">Medium - 60 minutes a day</label>
            <br>
            <input type="radio" id="petExercise" name="petExercise" value="High">
            <label for="petExercise">High - more than 60 minutes a day</label>
            <br>
            <input type="radio" id="petExercise" name="petExercise" value="VeryHigh">
            <label for="petExercise">Very high - 90 minutes a day</label>

            <p>7. How much time can you dedicate to socializing with your pet?
            </p>

            <input type="radio" id="petSocial" name="petSocial" value="Low">
            <label for="petSocial">Low - 20 to 30 minutes a day</label>
            <br>
            <input type="radio" id="petSocial" name="petSocial" value="Medium">
            <label for="petSocial">Medium - 60 minutes a day</label>
            <br>
            <input type="radio" id="petSocial" name="petSocial" value="High">
            <label for="petSocial">High - more than 60 minutes a day</label>
            <br>
            <input type="radio" id="petSocial" name="petSocial" value="VeryHigh">
            ...
            <input type="radio" id="petWeight" name="petWeight" value="Low">
            <label for="petWeight">Low - 0 to 20 lbs</label>
            <br>
            <input type="radio" id="petWeight" name="petWeight" value="Medium">
            <label for="petWeight">Medium - 20 to 30 lbs</label>
            <br>
            <input type="radio" id="petWeight" name="petWeight" value="High">
            ...
            <input type="radio" id="petFriendlyPets" name="petFriendlyPets" value="Yes">
            <label for="petFriendlyPets">Yes</label>
            <br>
            <input type="radio" id="petFriendlyPets" name="petFriendlyPets" value="No">
            ...
            <input type="radio" id="homeAlone" name="homeAlone" value="Low">
            <label for="homeAlone">Low - 4-6 hours a day</label>
            <br>
            <input type="radio" id="homeAlone" name="homeAlone" value="Medium">
            <label for="homeAlone">Medium - 8 hours a day</label>
            <br>
            <input type="radio" id="homeAlone" name="homeAlone" value="High">
            <label for="homeAlone">High - 12 hours a day</label>
            <br>
            <input type="radio" id="homeAlone" name="homeAlone" value="VeryHigh">
            <label for="homeAlone">Very high - 12+ hours a day</label>
                ...
                <button type="submit" style="background-color: rgba(255,242,43,0.85); width: 100%" id="survey" name="survey"
